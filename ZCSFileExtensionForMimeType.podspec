#
#  Be sure to run `pod spec lint ZCSFileExtensionForMimeType.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/zshannon/ZCSFileExtensionForMimeType.git", :tag => "0.0.2" }
  ...
  s.source_files  = "ZCSFileExtensionForMimeType.{h,m}"
